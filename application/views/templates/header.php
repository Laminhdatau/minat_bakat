...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('public/libra/'); ?>fontapis.css">
	<!-- Font Awesome -->
...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<div class="preloader flex-column justify-content-center align-items-center">
			<img class="animation__shake" src="<?= base_url('public/dist/img/logo.png') ?>" alt="AdminLTELogo" height="60" width="60">
		</div>
