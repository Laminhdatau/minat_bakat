				...
				<div class="col-lg-4">
					<div class="card">
						<div class="card-header">
							<div class="row">
								<div class="col-lg-10">
									<h4 class="card-title">New Jurusan</h4>
								</div>
							</div>
						</div>
						<form action="<?= site_url('master_data/jurusan/new') ?>" method="POST">
							<div class="card-body">
								...
								<tbody>
									...
									<?php foreach ($jurusan as $v) : ?>
										<tr>
											...
											<td><?= $v->jurusan; ?></td>
											<td>
												<a href="<?= base_url('master_data/jurusan/hapus/' . $v->id_jurusan) ?>">
													<button class="btn bg-danger btn-xs" style="width: 30px;">
